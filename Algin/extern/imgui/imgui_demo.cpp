            ...
            struct Funcs
            {
                static int MyResizeCallback(ImGuiInputTextCallbackData* data)
                {
                    if (data->EventFlag == ImGuiInputTextFlags_CallbackResize)
                    {
                        ...
                        my_str->resize(data->BufSize); // AG: On resizing calls, generally data->BufSize == data->BufTextLen + 1
...
static void ShowDemoWindowColumns()
{
    ...
    {
        // AG: Future columns API should allow automatic horizontal borders.
...
static void ShowDemoWindowInputs()
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Focus from code"))
        {
            ...
            ImGui::TextWrapped("AG: Cursor & selection are preserved when refocusing last used item in code.");
            ImGui::TreePop();
        }
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::BeginChild("ScrollingRegion", ImVec2(0, -footer_height_to_reserve), ImGuiChildFlags_NavFlattened, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            // AG- if you have thousands of entries this approach may be too inefficient and may require user-side clipping
