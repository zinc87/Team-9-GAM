...
namespace Script
{
    public class MainMenuButtons : IScript
    {
        ...
        public override void Start()
        {
            ...
            // Initialize fade overlay and fade in from black
            if (fadeOverlay != null)
            {
        ...
        public override void Update(double dt)
        {
            ...
            // Block all input while a fade is in progress
            ...
            if (leftClicked)
            {
                ...
                {
                    // Fade out, then load the Video Player scene
                    SceneFader.StartFadeOut("Assets\\Scenes\\Video Player.scene");
                    return;
                }
