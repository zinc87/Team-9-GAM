...
namespace Script
{
    public class SettingsPanelMgr : IScript
    {
        ...
        // GAMMA DISPLAY
        [SerializeField] public Script.Library.Object GammaText;
        ...
        public override void Start()
        {
            ...
            float gammaPct = GammaState.GetSliderPercent();
        ...
        public override void Update(double dt)
        {
            ...
            // GAMMA DISPLAY
            bool isHoveringGamma = IsOver(gammaSliderKnob, mp) || IsOver(gammaSliderTrack, mp);
            if (GammaText != null)
            {
                SetAlpha(GammaText, isHoveringGamma || isDraggingGamma ? 1f : 0f);
            }
        ...
        private void UpdateSlider(Script.Library.Object track, Script.Library.Object knob, Script.Library.Object textObj, Vector2D mp, bool isSoundSlider)
        {
            ...
            {
                GammaState.SetFromSliderPercent(pct);
            }
        }
