...
namespace Script
{
    public class TutorialTextMgrScript : IScript
    {
        ...
        public override void Awake()
        {
            ...
            TutorialTextMgr.Instance.initialize(TutorialTextMgr.promptState.Change_To_Needle, page8);
            TutorialTextMgr.Instance.initialize(TutorialTextMgr.promptState.Navigate_To_Machine_Rm, page9);
    ...
    public class TutorialTextMgr
    {
        ...
        public enum promptState
        {
            ...
            Select_Patient, // When interacted with the computer(PlayerController.cs)
            Furthur_Testing, //When Select patient (PatientUIPanel.cs)
            Scan_Patient, //When pressed further testing btn(PatientUIPanel.cs)
            Inspect_Organ, //When Using the scanner (InventoryManager.cs)
            Change_To_Needle, //When reaching page 3 of info (TutorialMgr.cs)
            Navigate_To_Machine_Rm, //When Blood sample collected (PlayerController.cs)
